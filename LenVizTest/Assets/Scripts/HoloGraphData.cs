...
namespace HoloGraph
{
    ...
    public class HoloGraphData
    {
        ...
        {
            Dictionary<string, object> h = (Dictionary<string, object>)headersJson;
        ...
        {
            Dictionary<string, object> h = (Dictionary<string, object>)headersJson;
            return (string)h["xAxis"];
        }

        public string GetYAxisTitle()
        {
            Dictionary<string, object> h = (Dictionary<string, object>)headersJson;
            return (string)h["yAxis"];
        }

        public string GetZAxisTitle()
        {
            Dictionary<string, object> h = (Dictionary<string, object>)headersJson;
            return (string)h["zAxis"];
        }

        public string GetGeom()
        {
            Dictionary<string, object> h = (Dictionary<string, object>)headersJson;
            return (string)h["type"];    // TODO: 'type' is really overloaded term, use "geom" instead
        }
    }
}
